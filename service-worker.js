const CACHE_NAME='wesh-baed-v193-authority-audit-1';
...
function fixResultUI(html){
  ...
  html=html.replace(/PREMIUM · v186/g,'PREMIUM · v193');
  ...
  html=html.replace("['الجهة المختصة',r.authority||'']","['الجهة المختصة',r.authority||r.court||r.competent_authority||({'SRC-SAMA-COMPLAINT':'البنك المركزي السعودي','SRC-SAMA-CONSUMER-PROTECTION':'البنك المركزي السعودي','SRC-IA-COMPLAINT':'هيئة التأمين','SRC-CST-ESCALATE':'هيئة الاتصالات والفضاء والتقنية'}[r.source_id]||'')]");
